  ...
  return (
    <form onSubmit={handleSignIn} autoComplete="on" className="flex flex-col gap-8">
      ...
      <div className="grid gap-4">
        ...
        <Button type="submit" variant="outline" disabled={isPending} className="mt-2 cursor-pointer">Sign In</Button>
      </div>
    </form>
  );
}
  ...
  return (
    <form onSubmit={handleSignUp} autoComplete="on" className="flex flex-col gap-8">
      ...
      <div className="grid gap-4">
        ...
        <Button type="submit" variant="outline" disabled={isPending} className="mt-2 cursor-pointer">Sign Up</Button>
      </div>
    </form>
  );
}
  ...
  async function handleGoogleSignIn() {
    ...
    return (
        <div className="mx-auto grid w-[350px] gap-2">
            ...
            <Button variant="outline" type="button" onClick={handleGoogleSignIn} disabled={isPending} className="cursor-pointer">
                <Image src="https://www.svgrepo.com/show/475656/google-color.svg" alt="Google icon" className="mr-2 h-4 w-4" width={4} height={4} />
                Continue with Google
            </Button>
            <Link
            href={"/"}
            className="text-sm text-blue-500 underline text-center pt-5"
            >
              Back to HomePage
            </Link>
        </div>
